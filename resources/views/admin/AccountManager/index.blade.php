                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"> {{trans('trans.AccountManager')}}</span>
                                        </div>
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="btn-group">
                                                        <a href="{{url('/')}}/AccountManager/create" id="sample_editable_1_new" class="btn sbold green"> {{trans('trans.Add New')}}
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                            ...
                                            <tbody>
                                            	...
                                            	@foreach($AccountManagers as $admin)
                                                <tr class="odd gradeX">
                                                    <td>
                                                        <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li>
                                                 <a href="{{url('/')}}/AccountManager/{{$admin->id}}/edit">
                                     <i class="icon-docs"></i>{{trans('trans.edit')}} </a>
                                                                </li>

                                                                 <li>
                                                 <a href="{{url('/')}}/AccountManager/{{$admin->id}}/destroy ">
